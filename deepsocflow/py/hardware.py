...
''')
    ...
    def simulate(self, SIM='verilator', SIM_PATH=''):
        ...
        if SIM == "verilator":
            cmd = f'{SIM_PATH}verilator --binary --trace -j 0 -O3 --relative-includes --top {self.TB_MODULE} -I../ -F ../sources.txt -CFLAGS -DSIM -CFLAGS -I../ {self.MODULE_DIR}/c/sim.c -CFLAGS -g --error-limit 0 --Mdir ./'
            print(cmd)
